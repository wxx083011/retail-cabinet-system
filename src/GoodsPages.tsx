...
function SmartCabinetDetail({ onBack, onInventory, onEditLocation }: { onBack: () => void; onInventory: () => void; onEditLocation?: () => void }) {
  // Tab 卡片与运营后台点位详情共用同一组件（LocationDetailTabs）
  return (
    <div className="p-6 bg-[#F5F7FA] min-h-screen">
      ...
      <LocationDetailTabs extraAction={onEditLocation ? <Btn v="primary" icon={I.edit} onClick={onEditLocation}>编辑点位信息</Btn> : undefined} />
    </div>
  );
}
